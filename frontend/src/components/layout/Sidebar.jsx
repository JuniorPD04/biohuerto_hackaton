...
export const MODULES = [
  ...
  },
  {
    ...
    group: "admin",
    roles: ["admin"],
    perm: "reportes.gestion",
    subs: [
      { id: "produccion", label: "Producción", path: "/reportes/produccion" },
      { id: "comunidad", label: "Comunidad", path: "/reportes/comunidad" },
      { id: "inversion", label: "Inversión x biohuerto", path: "/reportes/inversion" },
    ],
  },
